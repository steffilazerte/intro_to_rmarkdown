...
![](https://rmarkdown.rstudio.com/docs/reference/figures/logo.png){fig-alt="Rmarkdown hex logo featuring a light green feather pen in a dark teal hexagon with the word rmarkdown below" style="position:absolute; top:15%; right:10%; width: 20%"}
